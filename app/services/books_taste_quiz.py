...
PROFILES: list[dict] = [
    {
        ...
        "description": "You read to find out what happens. Pacing matters more than sentences. You're not here to be impressed — you're here to be pulled through. Gone Girl, The Kite Runner, Harry Potter.",
    },
    {
        "id": "prose_devotee",
        "name": "The Prose Devotee",
        "vector": {"prose": 1.0, "irony": 1.0, "plot": -1.0},
        "description": "The writing is the point. You'll follow a great sentence anywhere. Plot is scaffolding; what remains is language. Gatsby, Beloved, Blood Meridian, The Years.",
    },
    {
        "id": "emotional_immersive",
        "name": "The Emotional Immersive",
        "vector": {"emotional": 1.0, "darkness": 1.0, "commitment": 1.0},
        "description": "You want to feel everything. Length isn't a deterrent — it's an invitation. The best books leave a mark you carry for weeks. A Little Life, Normal People, Pachinko, When Breath Becomes Air.",
    },
    {
        "id": "ideas_reader",
        "name": "The Ideas Reader",
        "vector": {"ideas": 1.0, "moral_ambiguity": 1.0, "emotional": -1.0},
        "description": "Books are for changing how you think, not how you feel. A great argument matters more than a great sentence. 1984, Crime and Punishment, Sapiens, How to Change Your Mind.",
    },
    {
        "id": "dark_ironist",
        "name": "The Dark Ironist",
        "vector": {"irony": 1.0, "darkness": 1.0, "emotional": -1.0},
        "description": "Earnestness is suspicious. You're drawn to books that know they're absurd — humor as delivery mechanism for something bleak. Catch-22, Slaughterhouse-Five, Cuckoo's Nest.",
    },
    {
        "id": "warm_traditionalist",
        "name": "The Warm Traditionalist",
        "vector": {"emotional": 1.0, "darkness": -1.0, "prose": 0.3},
        "description": "You value story, character, and emotional truth in recognizable forms. The literary tradition isn't a constraint — it's the point. Mockingbird, Pride and Prejudice, The Remains of the Day.",
    },
    {
        "id": "narrative_nonfiction",
        "name": "The Narrative Nonfiction Reader",
        "vector": {"emotional": 1.0, "plot": 1.0, "nonfiction_register": -1.0},
        "description": "True stories told with the pace and texture of novels. You want to feel like you're inside something real. Educated, Into the Wild, Say Nothing, Henrietta Lacks.",
    },
    {
        "id": "ideas_first_nonfiction",
        "name": "The Ideas-First Nonfiction Reader",
        "vector": {"ideas": 1.0, "emotional": -0.5, "nonfiction_register": 1.0},
        "description": "Books are for changing how you think at scale. A great argument matters more than a great story. Sapiens, How to Change Your Mind, Body Keeps the Score.",
    },
]
