...
FILMS: list[dict] = [
    ...
    {"order": 47, "title": "Knives Out",                              "year": 2019,
     ...
     "generation": ["gen_z", "millennial", "universal"],
     "scenes": ["comedy", "action_thriller", "true_crime", "suspense_mystery"]},
    ...
    {"order": 62, "title": "Zodiac",                                  "year": 2007,
     ...
     "generation": ["millennial"],
     "scenes": ["true_crime", "action_thriller", "prestige_drama", "suspense_mystery"]},
    ...
    # Feel-good + comfort — the warm, rewatchable, happy-ending corner.
    # Diagnostically valuable: separating "likes light romance" from
    # "likes funny comfort" from "likes emotional uplift."
    {"order": 74, "title": "The Proposal",                              "year": 2009,
     "weights": {"comedy": 1, "emotional": 1, "darkness": -2, "ambiguity": -2},
     "generation": ["millennial"],
     "scenes": ["feelgood_comfort", "romance", "comedy"]},
    {"order": 75, "title": "My Big Fat Greek Wedding",                  "year": 2002,
     "weights": {"comedy": 1, "emotional": 2, "darkness": -2},
     "generation": ["millennial"],
     "scenes": ["feelgood_comfort", "romance", "comedy"]},
    {"order": 76, "title": "Julie & Julia",                             "year": 2009,
     "weights": {"emotional": 1, "pace": 1, "darkness": -2},
     "generation": ["millennial"],
     "scenes": ["feelgood_comfort", "cooking_food"]},
    {"order": 77, "title": "A Walk to Remember",                        "year": 2002,
     "weights": {"emotional": 2, "darkness": -1, "comedy": -1},
     "generation": ["millennial"],
     "scenes": ["feelgood_comfort", "romance", "faith_family"]},
    {"order": 78, "title": "The Secret Life of Walter Mitty",           "year": 2013,
     "weights": {"emotional": 1, "comedy": 1, "pace": 1, "ambiguity": 1},
     "generation": ["millennial", "gen_z"],
     "scenes": ["feelgood_comfort"]},
    # Suspense + mystery
    {"order": 79, "title": "Gone Girl",                                 "year": 2014,
     "weights": {"darkness": 2, "irony": 1, "genre": 1},
     "generation": ["millennial", "gen_z"],
     "scenes": ["suspense_mystery", "prestige_drama"]},
    {"order": 80, "title": "Shutter Island",                            "year": 2010,
     "weights": {"darkness": 1, "ambiguity": 2, "genre": 1},
     "generation": ["millennial"],
     "scenes": ["suspense_mystery", "action_thriller"]},
    {"order": 81, "title": "The Girl on the Train",                     "year": 2016,
     "weights": {"darkness": 1, "emotional": 1},
     "generation": ["millennial", "gen_z"],
     "scenes": ["suspense_mystery"]},
    # History + war
    {"order": 82, "title": "Saving Private Ryan",                       "year": 1998,
     "weights": {"emotional": 2, "darkness": 2, "film_history": 1},
     "generation": ["classic", "millennial", "universal"],
     "scenes": ["history_war", "action_thriller"]},
    {"order": 83, "title": "1917",                                      "year": 2019,
     "weights": {"pace": 1, "emotional": 1, "darkness": 2},
     "generation": ["gen_z", "millennial"],
     "scenes": ["history_war", "action_thriller"]},
    {"order": 84, "title": "Hidden Figures",                            "year": 2016,
     "weights": {"emotional": 2, "darkness": -1},
     "generation": ["gen_z", "millennial"],
     "scenes": ["history_war", "feelgood_comfort"]},
    {"order": 85, "title": "Hacksaw Ridge",                             "year": 2016,
     "weights": {"emotional": 2, "darkness": 2},
     "generation": ["gen_z", "millennial"],
     "scenes": ["history_war", "faith_family", "action_thriller"]},
    # Faith + wholesome
    {"order": 86, "title": "The Blind Side",                            "year": 2009,
     "weights": {"emotional": 2, "darkness": -2, "comedy": 1},
     "generation": ["millennial"],
     "scenes": ["faith_family", "feelgood_comfort", "sports"]},
    {"order": 87, "title": "Soul Surfer",                               "year": 2011,
     "weights": {"emotional": 2, "darkness": -1},
     "generation": ["millennial", "gen_z"],
     "scenes": ["faith_family", "feelgood_comfort", "sports"]},
    # Cooking + food
    {"order": 88, "title": "Ratatouille",                               "year": 2007,
     "weights": {"emotional": 1, "comedy": 1, "darkness": -2},
     "generation": ["millennial", "gen_z", "universal"],
     "scenes": ["cooking_food", "kids_family", "feelgood_comfort"]},
    {"order": 89, "title": "The Hundred-Foot Journey",                  "year": 2014,
     "weights": {"emotional": 1, "pace": 1, "darkness": -2},
     "generation": ["millennial"],
     "scenes": ["cooking_food", "feelgood_comfort", "romance"]},
    # More mainstream titles to round out coverage
    {"order": 90, "title": "The Martian",                               "year": 2015,
     "weights": {"comedy": 1, "emotional": 1, "genre": 1, "darkness": -1},
     "generation": ["millennial", "gen_z"],
     "scenes": ["scifi_fantasy", "feelgood_comfort"]},
    {"order": 91, "title": "Forrest Gump",                              "year": 1994,
     "weights": {"emotional": 2, "comedy": 1, "darkness": -1, "film_history": 1},
     "generation": ["classic", "millennial", "universal"],
     "scenes": ["feelgood_comfort", "history_war"]},
    {"order": 92, "title": "Mean Girls",                                "year": 2004,
     "weights": {"comedy": 2, "irony": 1, "darkness": -1},
     "generation": ["millennial", "gen_z", "universal"],
     "scenes": ["comedy", "feelgood_comfort"]},
    {"order": 93, "title": "The Greatest Showman",                      "year": 2017,
     "weights": {"emotional": 2, "comedy": 1, "darkness": -2},
     "generation": ["gen_z", "millennial"],
     "scenes": ["feelgood_comfort", "music"]},
]
